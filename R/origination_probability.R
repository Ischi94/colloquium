...
plot_ori <- ggplot(prob, aes(x = pal.int,
  ...
  annotate(geom = "segment", x = c(4, 1.25), y = c(0.22, 0.055), # overall
           xend = c(4.55, 0.575), yend = c(0.22, 0.055), colour = "grey60") +
  # annotate(geom = "segment", x = c(4), y = c(0.22), # overall
  #          xend = c(4.55), yend = c(0.22), colour = "grey40") +
  # add background box
  ...
  annotate(geom = "text", x = 4.275, y = c(0.25, 0.235), # overall
           colour = "grey40", label = c("Overall", "median"), size = 15/.pt) +
  annotate(geom = "text", x = 0.9, y = c(0.045, 0.03, 0.015), # per group
           colour = "grey40", label = c("Median", "per", "group"), size = 15/.pt) +
